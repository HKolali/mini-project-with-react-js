...
export default class ShoppingCart extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      products: [
        { id: 1, title: 'Red Grape', description: 'Juice - NetVolume: 240ml', image: './image/product/1.jpg' },
        { id: 2, title: 'Pomegranate', description: 'Juice - NetVolume: 240ml', image: './image/product/4.jpg' },
        { id: 3, title: 'Banana & Apple', description: 'Juice - NetVolume: 240ml', image: './image/product/9.jpg' },
        { id: 4, title: 'Lime', description: 'Juice - NetVolume: 240ml', image: './image/product/13.jpg' },
        { id: 5, title: 'Aloe+Grape', description: 'Juice - NetVolume: 240ml', image: './image/product/15.jpg' }
      ],
      cartItems: []
    }
  }
